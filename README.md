[![Open in Visual Studio Code](https://classroom.github.com/assets/open-in-vscode-2e0aaae1b6195c2367325f4f02e2d04e9abb55f0b24a779b69b11b9e10269abc.svg)](https://classroom.github.com/online_ide?assignment_repo_id=22257772&assignment_repo_type=AssignmentRepo)
...
- `401 Not Found` : Si l'utilisateur n'existe pas en base de données //pas faire
- `401 Bad Request` : Si le mot de passe ne correspond pas à l'utilisateur //pas faire
